...
public class BoardController extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (command.equals("/BoardListAction.do")) {//등록된 글 목록 페이지 출력하기
			...
			RequestDispatcher rd = request.getRequestDispatcher("./project/board/list.jsp");
			rd.forward(request, response);
		} else if (command.equals("/BoardWriteForm.do")) { // 글 등록 페이지 출력하기
				requestLoginName(request);
				RequestDispatcher rd = request.getRequestDispatcher("./project/board/writeForm.jsp");
				rd.forward(request, response);				
				...
				RequestDispatcher rd = request.getRequestDispatcher("./project/board/view.jsp");
				rd.forward(request, response);	
