...
<%@ page import="mvc.model.BoardVO"%>

<%
	BoardVO notice = (BoardVO) request.getAttribute("board");
...
<body>
	...
	<div class="container">
		<form name="newUpdate"
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input name="name" class="form-control"	value=" <%=notice.getUserName()%>">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<c:set var="userId" value="<%=notice.getUserID()%>" />
	...
	<jsp:include page="../login/mainPage.jsp" />
</body>
</html>
