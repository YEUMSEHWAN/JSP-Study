...
<body>
	<div align="center">
		<b>글 쓰기</b><br> <br>
		<form
			action="/ServletProjet/board/updatePro.bdo?pageNum=${ pageNum}ageNum %>"
			...
			<table width="400" border="1" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="330" align="left"><input type="text" size="12"
						maxlength="12" name="writer" value="${Particle.writer}"> <input
						type="hidden" name="num" value="${article.num }>"></td>
				</tr>


				<tr>
					<td width="70" bgcolor="${value_c }" align="">제목</td>
				...
				<tr>
					<td colspan="2" bgcolor="${value_c }" align="center"><input
						...
						onclick="window.location.href='/ServletProjet/board/list.bdo?pageNum=${pageNum}'"></td>
				</tr>
			</table>
		</form>
	</div>
