...
String check = request.getParameter("check");//<--스크립트로 처리
String dong = request.getParameter("dong");

//파라미터 값을 zipcodeRead()메소드의 매개 변수로 전달
...
<body bgcolor="#FFFFCC">
	<div align="center">
		...
		<form action="zipCheck.jsp" name="zipForm" method="post">
			<table>
				<tr>
					<td>동이름 입렵: <input type="text" name="dong"> <input type="button" value="검색" onclick="dongCheck()">
					</td>
				</tr>
			</table>
		...
		<table>
			...
			%>
			<tr>
				<td align="center"><br> ※ 검색 후, 아래 우편번호를 클릭하면 자동으로 주소가
					입력됩니다.</td>
			</tr>
			<%
