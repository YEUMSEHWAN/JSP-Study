	...
	<c:choose>
		<c:when test="${loginID ne null }">
			...
			<table width="300" border="1">
				...
				<tr>
					<td colspan="3" align="center"><c:out value="${loginID}" />님환영합니다.</td>
				</tr>
				...
				<tr>
					...
					<td width="100" align="center"><a
						href="member.mdo?cmd=deleteForm">회원탈퇴</a>
					<td width="100" align="center"><a href="member.mdo?cmd=logout">로그아웃</a></td>
				</tr>
			</table>
		</c:when>
		<c:otherwise>
