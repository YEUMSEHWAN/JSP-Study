...
try {
	...
	paramTitle = multi.getParameter("txtTilte");
...
<body>
	<table width="75%" border="1" align="center" cellpadding="1"
		...
		<tr>
			...
			<td width="50%" colspan="3"><textarea rows="5" cols="50"><%=paramAbstract%></textarea>
			</td>
		</tr>
		...
		<tr bgcolor="FFCC00">
			<td colspan="4"><a
				href="<%="/ServletProject/" + saveFolder + "/" + saveFiles.get(i)%>">
