...
<script type="text/javascript">
	...
	function elementCheck(formName) {
		...
		for(idx =0; idx<formName.lelments.length;idx++){
...
<body topmargin="100">
	<div align="center">
		...
		<font size="2" color="#0000FF"> 복수개의 파일을 업로드를 위하여 파일 개수를 입력한 후
			<br> 확인 버튼을 눌러주세요 !!!<br> 입력이 완료되면 Done 버튼을 눌러주세요.
		</font>
	</div>
	<br>
	...
	<form method="post" name="frmName1">
		<table width="75%" border="1" align="center" cellpadding="1"
			...
			<tr bgcolor="#FFCC00">
				<td width="10%" align="right"><div>user</div></td>
				<td><input type="text" name="user"
					onkeyup="inputValue(this.form.user.frmName2,0)"
					value="<%=getParam(request, "user")%>"></td>

				<td width="10%" align="right"><div>title</div></td>
				<td><input type="text" name="title"
					onkeyup="inputValue(this.form.title.frmName2,0)" value="<%=getParam(request, "title")%>"></td>
			...
			<tr bgcolor="FFCC00">
				...
				<td width="50%" colspan="3"><textarea cols="40" name="abstract"
						onkeyup="inputValue(this.form.title.frmName2,0)">
	<%=getParam(request, "abstract")%>
			...
			<tr>
				<td colspan="4">
					<div align="center">
						<font size="2">추가할 파일 수 입력</font> <input type="text" name="addcnt">
	...
	<form name = "frmName2" method = "post" enctype = "multipart/form/">
		<table width = "75%" border="1" align = "center" cellpadding = "1"
			cellspacing = "1" bordercolor = "#660000" bgcolor = "#FFFF99">
			<tr bgcolor="#FFCC00">
				<td width="40%"><input type="hidden" name="txtUser"
					value="<%=getParam(request, "user")%>"> <input type="hidden"
					name="txtTitle" value="<%=getParam(request, "title")%>"> <input
 ...
 %>
				...
				<td align = "center"><input type="button" value="Done" onclick="elementCheck(this.form)">
				</td>
			</tr>
