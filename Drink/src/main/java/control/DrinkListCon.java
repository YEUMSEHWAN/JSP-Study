...
@WebServlet("/DrinkListCon.do")
public class DrinkListCon extends HttpServlet {
	...
	protected void reqPro(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 게시글의 갯수
		int count=0;
		//jsp페이지 내에서 보여질 넘버링 수자값을 저장하는 변수
		int number = 0;
		...
		Vector<DrinkBean> v = bdao.getAllDrink(startRow, endRow);
		...
		RequestDispatcher dis = request.getRequestDispatcher("index.jsp?center=DrinkList.jsp");
